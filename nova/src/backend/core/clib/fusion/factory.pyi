...
def ones(shape: list[int]) -> nova.src.backend.core.clib.fusion.Tensor:
    ...
    """
def ones_like(other: nova.src.backend.core.clib.fusion.Tensor) -> nova.src.backend.core.clib.fusion.Tensor:
    """
...
def zeros(shape: list[int]) -> nova.src.backend.core.clib.fusion.Tensor:
    ...
    """
def zeros_like(other: nova.src.backend.core.clib.fusion.Tensor) -> nova.src.backend.core.clib.fusion.Tensor:
    """
