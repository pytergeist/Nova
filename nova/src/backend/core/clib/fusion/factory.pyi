...
def fill(
    shape: list[int], value: float, device: Device
) -> nova.src.backend.core.clib.fusion.Tensor:
    """
    Create a tensor filled with a given value
    """

def ones(shape: list[int], device: Device) -> nova.src.backend.core.clib.fusion.Tensor:
    """
...
def zeros(shape: list[int], device: Device) -> nova.src.backend.core.clib.fusion.Tensor:
    """
