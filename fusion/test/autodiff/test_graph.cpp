...
TEST_F(GraphTest,
       new_intermediate_value_resizes_produced_by_and_consumed_by_tables) {
...
TEST_F(GraphTest,
       new_values_are_sequential_across_input_and_intermediate_allocations) {
...
TEST_F(GraphTest,
       append_consumer_table_appends_multiple_consumers_for_same_value) {
   ValueID vid = h.new_intermediate_value();
...
TEST_F(GraphTest,
       produced_and_consumer_book_keeping_can_be_connected_manually) {
...
// TODO: Evaluate whether you need the below test,
