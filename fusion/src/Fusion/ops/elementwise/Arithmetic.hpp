...
DenseTensor<T> add(const DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   fusion::dense::iter::binary_ewise_tag<T, AddSIMD>(x, y, meta, out);
   return out;
}
...
DenseTensor<T> sub(const DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   BinaryEwiseMeta meta = make_binary_meta(x, y);
   DenseTensor<T> out = init_out_from_meta(x, y, meta);
   fusion::dense::iter::binary_ewise_tag<T, SubtractSIMD>(x, y, meta, out);
   return out;
}
...
DenseTensor<T> mul(const DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   BinaryEwiseMeta meta = make_binary_meta(x, y);
   DenseTensor<T> out = init_out_from_meta(x, y, meta);
   fusion::dense::iter::binary_ewise_tag<T, MultiplySIMD>(x, y, meta, out);
   return out;
}
...
DenseTensor<T> div(const DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   BinaryEwiseMeta meta = make_binary_meta(x, y);
   DenseTensor<T> out = init_out_from_meta(x, y, meta);
   fusion::dense::iter::binary_ewise_tag<T, DivideSIMD>(x, y, meta, out);
   return out;
}
...
DenseTensor<T> pow(const DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   BinaryEwiseMeta meta = make_binary_meta(x, y);
   DenseTensor<T> out = init_out_from_meta(x, y, meta);
   fusion::dense::iter::binary_ewise_tag<T, PowerSIMD>(x, y, meta, out);
   return out;
}
...
inline DenseTensor<T> reciprocal(const DenseTensor<T> &x) {
   ...
   fusion::dense::iter::unary_ewise_tag<T, ReciprocalSIMD>(x, meta, out);
   return out;
}
...
inline void sub_inplace(DenseTensor<T> &x, const DenseTensor<T> &y) {
   ...
   fusion::dense::iter::binary_ewise_tag<T, SubtractSIMD>(x, y, meta, x);
}
