...
template <class Tag>
consteval void require_ewise_binary_out_of_place() {
...
template <class Tag>
consteval void require_ewise_unary_out_of_place() {
  constexpr OpSchema s = OpTraits<Tag>::schema;
...
template <class Tag>
consteval void require_reduction_out_of_place() {
  constexpr OpSchema s = OpTraits<Tag>::schema;
...
template <class Tag>
consteval void require_contraction_out_of_place() {
  constexpr OpSchema s = OpTraits<Tag>::schema;
