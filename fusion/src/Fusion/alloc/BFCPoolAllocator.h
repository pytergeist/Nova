...
class RegionManager {
 public:
   ...
   RegionManager &operator=(const RegionManager &) = default;
   RegionManager(RegionManager &&) noexcept = default;
   RegionManager &operator=(RegionManager &&) noexcept = default;
...
class PoolAllocator : public IAllocator {
 ...
 private:
   ...
   void *allocate_bucket_region(std::size_t region, Alignment alignment) {
   ...
   void static delete_chunk(Chunk &chunk) {
      chunk.size = 0;
      chunk.requested_size = 0;
      chunk.ptr = nullptr;
